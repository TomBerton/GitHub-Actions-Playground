...
class TestCode(unittest.TestCase):
    ...
    def test_function_runs(self):
        arg_1_unsolved.convert_minutes_to_hours(10)

    # Test that the minutes are a floating point number.
    def test_minutes_is_float(self):
        self.assertIsInstance(arg_1_unsolved.convert_minutes_to_hours(10), float)

    # Test that the minutes are converted to hours
    def test_minutes_converted_to_hours(self):
        self.assertEqual(arg_1_unsolved.convert_minutes_to_hours(60), 1.0)
    ...
    def test_input_output_outside_function_template(self):
        ...
        p = Popen([f'python \"{code_path}/arg_1_unsolved.py\"'], shell=True,
